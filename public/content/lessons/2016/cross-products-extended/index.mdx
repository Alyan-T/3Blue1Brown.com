...
<Figure
    ...
    caption="Even though we are drawing the vector $\vec{\mathbf{u}}$ as $\left[\begin{array}{c}-2 \\ 0 \\ 3\end{array}\right]$ in the figure which gives the parallelepided a tangible volume, still think about $\vec{\mathbf{u}}$ as a variable that is free to change."
/>
